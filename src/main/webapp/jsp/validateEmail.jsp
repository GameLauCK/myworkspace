		...
		<div>
			<div style="width: 520px" class="card shadow p-5 d-flex flex-column justify-contect-center">
				<div class="mx-0 text-start">
					...
					<h3 class="mx-0 fw-bold" >Step 1</h3>
					<p class="mx-0 mb-1">Type your email here.</p>
				</div>
				<form:form class="mx-0" id="emailForm" modelAttribute="validateEmail" action="resetPassword"
					method="post">
						<div class="mx-0 mt-2 mb-3">
							<form:input class="m-0 form-control" placeholder="Email" id="email" path="email" name="email"/>
						</div>
						<div class="mx-0 mt-2 mb-3">
							<form:button class="m-0 btn btn-primary" id="validateEmail" name="validateEmail">Enter</form:button>
						</div>
